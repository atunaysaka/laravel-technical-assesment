...
@section('content')
    <div class="container my-5">
        ...
        <div class="filters my-4 mx-2">
            <form action="{{ route('transactions') }}" method="GET" class="filters-form form-inline">
                <label class="form-label"><i class="fa-regular fa-calendar"></i> Dates:</label>
                <input name="dates"class="datepicker mt-2 mx-2">

                <label class="form-label">Status:</label>
                <select name="status">
                    <option <?php echo (!$initialValues['status'] ? 'selected' : ''); ?> value="">ANY</option>
                    <option <?php echo ($initialValues['status'] == 'APPROVED' ? 'selected' : ''); ?>>APPROVED</option>
                    <option <?php echo ($initialValues['status'] == 'WAITING' ? 'selected' : ''); ?>>WAITING</option>
                    <option <?php echo ($initialValues['status'] == 'DECLINED' ? 'selected' : ''); ?>>DECLINED</option>
                    <option <?php echo ($initialValues['status'] == 'ERROR' ? 'selected' : ''); ?>>ERROR</option>
                </select>
